...
yamanote_area_grid = yamanote_area %>% 
  st_make_grid(st_bbox(.), square = F, cellsize = 0.004) 
tm_shape(yamanote_area_grid) + tm_polygons()

tm_shape(yamanote_area) + 
  tm_polygons(col = "red", alpha = 0.4) +
  tm_shape(attractions_points) + 
  tm_dots("P12_005e", size=0.2, alpha = 0.9)
```

```{r calculate shortest paths}
