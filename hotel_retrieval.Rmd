...
#https://www.expedia.com/Hotel-Search?destination=Tokyo%2C+Japan&latLong=35.675%2C139.76&regionId=179900&startDate=11%2F06%2F2019&endDate=11%2F07%2F2019&rooms=1&adults=1

# url_file = here::here("data/Tokyo (and vicinity), Japan Hotel Search Results.html")

# test_url = "https://www.expedia.com/Hotel-Search?destination=Tokyo%2C+Japan&latLong=35.675%2C139.76&regionId=179900&startDate=11%2F06%2F2019&endDate=11%2F07%2F2019&rooms=1&adults=1"

# #RSelenium: start server
# checkForServer()
# startServer()
# remDr = remoteDriver()
# remDr$open()
...
# #scroll
# for(i in 1:10) {
#   remDr$executeScript(str_glue("scroll(0,{i*10000});"))
#   Sys.sleep(2)
# }
# 
# #get html
# page_src = remDr$getPageSource()

# html = read_html(url_file)

# html %>% html_nodes("div[class='uitk-card uitk-grid imagelayout-left-fullbleed']")
```
